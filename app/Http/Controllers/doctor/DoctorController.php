...
$get_day = $get_day->delete();
     ...
     public function editWeeklyDay(Request $request)
    {
      ...
      $weekly_da['from_time'] = date('H:i',strtotime(timezoneAdjustmentFetch($time_zone, date('Y-m-d'), $weekly_day->from_time)));
      $weekly_da['to_time'] = date('H:i',strtotime(timezoneAdjustmentFetch($time_zone, date('Y-m-d'), $weekly_day->to_time)));
