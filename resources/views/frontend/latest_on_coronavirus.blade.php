                ...
                @forelse ($news_banners as $news_banner)
                    <div class="carousel-item @if ($loop->iteration == 1) active @endif">
                        <div class="news-banner-img">
                            <img src="{{ asset('public/uploads/corona/' . $news_banner->image) }}" alt="">
                        </div>
                    </div>
                @empty
                ...
                <div class="col-lg-8">
                    ...
                    <div class="news-listing for-w-100">
                        ...
                        <div class="news-listing-bottom">
                            ...
                            <div class="news-cont">
                                <p>{{ $news->sort_content }}
                                    <a href="{{ route('latestOnCoronavirusDetails',$news->slug) }}" class="view-moreilink">View more</a>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="resent-listing for-w-100">
                            <ul>
                                ...
                                <li><i class="fal fa-angle-right"></i>
                                    <span class="min-cont"><a href="{{ route('latestOnCoronavirusDetails',$news->slug) }}">{{ $news->heading }}</a><span>{{ date('M-d-Y H:i A',strtotime($news->created_at)) }} |<span>{{ $news->posted_by }}</span> </span>
                                </li>
                                 @empty
                     <li><i class="fal fa-angle-right"></i>
