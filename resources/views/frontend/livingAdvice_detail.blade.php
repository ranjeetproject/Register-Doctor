        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="resent-post for-w-100">
                        <h3>Recent Posts</h3>
                        <form method="get" action="{{ route('livingAdvice') }}">
                            <select
                                ...
                                @forelse ($latest_news as $news)
                                    <li><i class="fal fa-angle-right"></i>
                                        <span class="min-cont"><a
                                                href="{{ route('livingAdviceDetails', $news->slug) }}">{{ $news->heading }}</a><span>{{ date('M-d-Y H:i A', strtotime($news->created_at)) }}
