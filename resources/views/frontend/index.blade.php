         ...
         <div class="col-sm">
            ...
            <div class="opction-one">
               <div class="opction-one-top-image">
                  <img src="{{ asset('images/frontend/images/opction-one-top-image3.png') }}" alt="">
                     ...
                     <div class="carousel-inner">
                        <div class="carousel-item active">
                           <div class="opction-one-bottom-left">
                                 <h4>Option 1</h4>
                              <img src="{{ asset('images/frontend/images/doc-pic.jpg') }}" class="d-block" alt="...">
                           </div>
