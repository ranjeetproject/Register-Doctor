...
@section('content')
    ...
    {{-- <div class="col Post-prescription-right innerpage Prescriptions-page"> --}}
        <div class="row">
            <div class="col-sm-12">
            ...
            <div class="row flax  align-items-top Prescriptions-step">
                ...
                <div class="col-sm-9">
                    ...
                    <p>
                        Option A. Prescription is posted to you (takes 2-3 working days) then take it to
your local Pharmacy to collect drug. <span>Limited to UK Pharmacies & UK delivery addresses.</span>
                    </p>
                    <p>OR</p>
