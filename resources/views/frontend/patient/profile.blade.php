                    ...
                    <div class="tab-pane fade show active input-effect" id="Patient-Profile">
                        <form class="for-w-100" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="patient-flex-bx-top">
                                ...
                                <span class="patient-cp-link">Change password to <a href="#">Click here</a></span>
                            </div>
                            <div class="row main-form-fild">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group required has-float-label">
                                        <input onfocus="(this.type='date')" class="form-control {{!empty($user->profile->dob) ? 'has-content':''}}" name="dob" value="{{$user->profile->dob}}" id="pdob" placeholder="Date of Birth">
