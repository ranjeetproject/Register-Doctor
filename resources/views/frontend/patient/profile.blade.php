...
@section('content')
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="profile-tabs-wrap">
                    ...
                    <a class="nav-link btn blue-button" href="#">
                        Delete History
                    </a>
                </div>
                    ...
                    <div class="tab-pane fade show active input-effect" id="Patient-Profile">
                        <form class="for-w-100" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row main-form-fild">
                                    ...
                                    <div class="form-group required has-float-label">
                                        <select name="gender"
                                            ...
                                            <option value="male" {{ $user->profile->gender == 'male' ? 'Selected' : '' }}>
                                                Male</option>
                                            <option value="female"
                                                {{ $user->profile->gender == 'female' ? 'Selected' : '' }}>Female</option>
                                            <option value="other"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group required">
                                        <input type="date"
                                            ...
                                            name="dob" value="{{ date('Y-m-d', strtotime($user->profile->dob)) }}">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group has-float-label">
                                        <input type="tel" name="telephone2"
                                            class="form-control {{ !empty($user->profile->telephone2) ? 'has-content' : '' }}"
                                            value="{{ $user->profile->telephone2 }}" id="Ptelephone2"
                                ...
                                <div class="col-sm-12">
                                    <label><strong>GP or Family Doctor</strong> GP address mandatory if you want a
                                        prescription via this website and have a UK GP</label>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group has-float-label">
                                        <input type="text" name="gp_name"
                                            class="form-control {{ !empty($user->profile->gp_name) ? 'has-content' : '' }}"
                                            value="{{ $user->profile->gp_name }}" id="pName" placeholder="Name">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group has-float-label">
                                        <input type="text" name="gp_address"
                                            class="form-control {{ !empty($user->profile->gp_address) ? 'has-content' : '' }}"
                                            value="{{ $user->profile->gp_address }}" id="pgpAddress" placeholder="Address">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group has-float-label">
                                        <input type="tel" name="gp_telephone" value="{{ $user->profile->gp_telephone }}"
                                            class="form-control {{ !empty($user->profile->gp_telephone) ? 'has-content' : '' }}"
                                            id="pgpTelephone" placeholder="Telephone">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group has-float-label">
                                        <input type="text" name="gp_email" value="{{ $user->profile->gp_email }}"
                                            class="form-control {{ !empty($user->profile->gp_email) ? 'has-content' : '' }}"
                                            id="pgpemail" placeholder="Email">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group has-float-label">
                                        <input type="text" name="n_of_kin_name" value="{{ $user->profile->n_of_kin_name }}"
                                            class="form-control {{ !empty($user->profile->n_of_kin_name) ? 'has-content' : '' }}"
                                            id="pNamekin" placeholder="Name">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group has-float-label">
                                        <input type="text" name="n_of_kin_address"
                                            value="{{ $user->profile->n_of_kin_address }}"
                                            class="form-control {{ !empty($user->profile->n_of_kin_address) ? 'has-content' : '' }}"
                                            id="pAddresskin" placeholder="Address">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group has-float-label">
                                        <input type="text" name="n_of_kin_relationship"
                                            value="{{ $user->profile->n_of_kin_relationship }}"
                                            class="form-control {{ !empty($user->profile->n_of_kin_relationship) ? 'has-content' : '' }}"
                                            value="{{ $user->profile->n_of_kin_relationship }}" id="pRelationship"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group has-float-label">
                                        <input type="text" name="n_of_kin_phone"
                                            value="{{ $user->profile->n_of_kin_phone }}" class="form-control"
                                            id="pPhoneNo" placeholder="Phone No.">
    ...
    <div class="modal fade" id="Pharmacy-popup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
