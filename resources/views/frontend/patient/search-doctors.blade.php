...
@section('content')
    <div class="col Post-prescription-right innerpage  Choose-Your-Doctor-page">
                ...
                <div class="col Choose-Your-Doctor-right">
                    ...
                    <div class="row">
                        <div class="col-sm-12 prescription-fees text-center">
                            ...
                            <p>
                                Doctors will only provide a prescription if clinically indicated and will not issue a refund
                                if they decide not prescride a drug Controlled drugs cannot be prescribed.
                    ...
                    <div class="row my-3 pick-a-prescriber">
                        <div class="col-sm-12">
                            <div class="ask-all-doc">
                                <h3 class="text-center">WE ADVISE THIS OPTION UNLESS YOU HAVE A SPECIFIC DOCTOR IN MIND
                                    <img src="images/ex-icon.png" alt="" data-toggle="tooltip" data-placement="top"
                                        title="One line Definition"></h3>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        Doctors respond with availability - select one that suits you - standard fee <i
                                            class="fas fa-pound-sign"></i> 29.99
                                    </li>
                                    <li>
                                        After consultation prescription is posted to you (take to Pharmacist) or
                                        electronically to participating pharmacist.
                                    </li>
                                    <li>
                                        You pay pharmacist for drug <button type="button" onclick="quickQuestions()"
                                            class="btn btn-primary Send-Requests">Send Requests</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row my-3 pick-a-prescriber">
                        <div class="col-sm-12 text-center">
                            <h3 class="">PICK A PRESCRIBER <sup><img src=" images/ex-icon.png" alt="" data-toggle="tooltip"
                                data-placement="top" title="One line Definition"></sup></h3>
                        ...
                        <div class="col-sm-12">
                            <ul>
                                ...
                                <li>
                                    After consultation prescription is posted to you(take to any Pharmacist) or
                                    electronically to participating pharmacist
                                </li>
                                <li>
                    ...
                    <div class="row tex-center gp-Specialists">
                        <div class="col  d-flex gp-s-det">
                            <p>Most common prescriptions can be given by GOs <br> Specialists might only prescribe in a
                                small field <img src="images/ex-icon.png" alt="" data-toggle="tooltip" data-placement="top"
                                    title="One line Definition"> </p>
                                            ...
                                            <div class="card-body-cont">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <h5 class="card-title">
                                                            {{ $doctor->forename . ' ' . $doctor->surname }}<br><small>
                                                                {{ $doctor->profile->dr_speciality }}</small> </h5>
        ...
        <div class="modal fade Ask-Question2" id="Ask-Question" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="modal-body" method="POST" action="{{ route('patient.create-case') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="case_file[]" class="form-control-file"
                                        id="exampleFormControlFile1" multiple><br> <img data-toggle="tooltip"
                                        data-placement="right" title="" data-original-title="One line definition"
                                        src="images/ex-icon.png" alt="">
                                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <textarea class="form-control" name="medicine_name" id="exampleFormControlTextarea1"
        ...
        <div class="modal fade Ask-Question" id="Ask-Question" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
