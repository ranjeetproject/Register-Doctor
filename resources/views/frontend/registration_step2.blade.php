    ...
    <section class="for-w-100 main-content innerpage  login-page">
        <div class="container">
            ...
            <div class="row d-flax  align-items-center     justify-content-center  Patient-Profile-page">
                <div class="col-sm-10">
                    <form class="for-w-100" method="post"
                        action="{{ route('registration-step2', Crypt::encrypt($user->id)) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row main-form-fild input-effect">
                            ...
                            @if ($user->role == 2)
                                <div class="col-sm-12">
                                    ...
                                    <div class="for-profile-image">
                                        ...
                                        <img id="blah" src="{{ asset('public/images/frontend/images/step2.png') }}"
                                            alt="your image">
                            ...
                            @if ($user->role == 3)
                                <div class="col-sm-12">
                                    <div class="form-group required">
                                        <textarea name="pharmacy_name"
                                            class="form-control effect-19">{{ old('pharmacy_name') }}</textarea>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group required">
                                        <textarea name="location"
                                            class="form-control effect-19">{{ old('location') }}</textarea>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group required">
                                        <input type="text" name="telephone1" class="form-control effect-19" placeholder=""
