            ...
            <div class="col Case-Conclusion-live-Video-and-live-Chat-right">
                ...
                <div class="col-sm-12">
                    <div class="view-case-details">
                        <ul>
                            <li><label>Name </label><span class="cont"> <span>:</span>   {{$return['case_details']->user->name}}</span></li>
                            <li><label>Sex </label><span class="cont"> <span>:</span>    {{$return['case_details']->user->profile->gender}}</span></li>
                            <li><label>Date of Birth </label><span class="cont"> <span>:</span>    {{date('d F Y',strtotime($return['case_details']->user->profile->dob))}}</span></li>
                            <li><label>Address </label><span class="cont"> <span>:</span>  {{$return['case_details']->user->profile->address}}</span></li>
                            <li><label>Unique Patient Number (UPN) </label><span class="cont"> <span>:</span>   {{$return['case_details']->user->registration_number}}</span></li>
                        </ul>
                    </div>
