                            ...
                            <div class="chat-body" id="chat_list" style="height: 300px;">
                                ...
                                <div class="chat-body-you">
                                    ...
                                    <div class="chat-body-right">
                                        <h3>{{ $case->user->name }}
                                            <small>{{ date('d-m-Y h:i:s', strtotime($case->created_at)) }}</small></h3>
...
@push('scripts')
    ...
    <script type="text/javascript">
            ...
            setTimeout(() => {
                ...
                $.each(chatDetails, function(key, value) {
                    ...
                    if (value.sender_id != '{{ Auth::guard('siteDoctor')->user()->id }}') {
                        ...
                        chatData +=
                            '<div class="chat-body-me"><div class="chat-body-left"><img src="{{ Auth::guard('siteDoctor')->user()->profile->profile_photo }}" alt=""></div><div class="chat-body-right"><h3>You <small>' +
                            time + '</small></h3><p>' + value.message + '</p></div></div>';
                            doc_count++;
                    }
                });
                // $(".overlay").hide();
                $("#rec_user_id").data('doctor-count', doc_count);
        ...
        $('#upload_form').on('submit', function(event) {
            ...
            if($('#rec_user_id').data('doctor-count') < 3) {
                $.ajax({
