    ...
    <!-- /.col -->
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body p-0">
                <form action="{{ route('admin.specialties.delete') }}" method="post">
                          @csrf
              ...
              <div class="mailbox-controls">
               ...
               {{--    <a href="" class="btn btn-default btn-sm"><i class="fas fa-eye"></i></a>
                  ...
                  <a href="{{ route('admin.specialties.create') }}" data-toggle="tooltip" title="Add new specialties" class="btn btn-primary btn-sm"><i class="fas fa-plus-square"></i> New</a>
                <!-- /.btn-group -->
                  ...
                  <tbody id="search_result">
                    @forelse ($specialties as $specialty)
                      ...
                      <div class="icheck-primary">
                        ...
                        <a class="btn btn-sm btn-outline-warning" href="{{ route('admin.specialties.edit', $specialty->id) }}"> <i class="fas fa-edit"></i> Edit</a>
            ...
            <div class="card-footer p-0">
              <div class="mailbox-controls">
                ...
                <div class="float-right">
                  ...
                  <div class="btn-group">
                    {{ $specialties->onEachSide(1)->links() }}
                  </div>
                  <!-- /.btn-group -->
                </div>
                <!-- /.float-right -->
