...
@section('header', 'Add Latest on Coronavirus')
@section('badge')
    <li class="breadcrumb-item"><a href="{{ route('admin.coronavirus') }}">Latest on Coronavirus</a></li>
    <li class="breadcrumb-item"><a href="{{ route('admin.coronavirus.create') }}">Add Latest on Coronavirus</a></li>
@endsection


<div class="card">
    <div class="card-header">
        <h3 class="card-title">Latest on Coronavirus add</h3>
    </div>
    <div class="card-body">
        <form role="form" action="{{ route('admin.coronavirus.create') }}" method="POST" enctype="multipart/form-data"
            id="cmsForm">
            {{ csrf_field() }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input class="form-control @error('heading') is-invalid @enderror" type="text" name="heading"
                            id="heading" placeholder="Please enter coronavirus news heading" maxlength="191"
                            value="{{ old('heading') }}">
                        @error('heading')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input class="form-control @error('news_type') is-invalid @enderror" type="text"
                            name="news_type" id="news_type" placeholder="Please enter coronavirus type" maxlength="191"
                            value="{{ old('news_type') }}">
                        @error('news_type')
                            <span class="error invalid-feedback" id="error_description">{{ $message }}</span>
                        @enderror
