...
@section('body')
          @section('header', 'Latest on Coronavirus')
          @section('badge')
    ...
    <!-- /.col -->
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">Latest on Coronavirus list</h3>
            ...
            <div class="card-body p-0">
                <form action="{{ route('admin.coronavirus.delete') }}" method="post">
                          @csrf
              ...
              <div class="mailbox-controls">
               ...
               {{--    <a href="" class="btn btn-default btn-sm"><i class="fas fa-eye"></i></a>
                  ...
                  <a href="{{ route('admin.coronavirus.create') }}" data-toggle="tooltip" title="Add new coronavirus news" class="btn btn-primary btn-sm"><i class="fas fa-plus-square"></i> New</a>
                <!-- /.btn-group -->
                  ...
                  <tbody id="search_result">
                    @forelse ($news as $news)
                      ...
                      <div class="icheck-primary">
                        ...
                        <a class="btn btn-sm btn-outline-warning" href="{{ route('admin.coronavirus.edit', $news->id) }}"> <i class="fas fa-edit"></i> Edit</a>
                        <a class="btn btn-sm btn-outline-danger" onclick="return confirm('Are you sure want to delete?');" href="{{ route('admin.coronavirus.delete', $news->id) }}"> <i class="fas fa-trash-alt"></i> Delete</a>
