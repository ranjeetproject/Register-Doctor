...
@section('header', 'Add Routes')
@section('badge')
    <li class="breadcrumb-item"><a href="{{ route('admin.route') }}">Routes</a></li>
    <li class="breadcrumb-item"><a href="{{ route('admin.create-route') }}">Add Routes</a></li>
@endsection


<div class="card">
    <div class="card-header">
        <h3 class="card-title">Routes Add</h3>
    </div>
    <div class="card-body">
        <form role="form" action="{{route('admin.save-route')}}" method="POST" enctype="multipart/form-data"
            id="cmsForm">
            {{ csrf_field() }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input class="form-control @error('route_name') is-invalid @enderror" type="text" name="route_name"
                            id="route_name" placeholder="Please enter Route" maxlength="191"
                            value="{{ old('name') }}">
                        @error('route_name')
