    ...
    <!-- /.col -->
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">Home Page Banner list</h3>
            ...
            <div class="card-body p-0">
                <form action="{{ route('admin.home_page_banner.delete') }}" method="post">
                          @csrf
                  ...
                  <tbody id="search_result">
                    @forelse ($pages as $page)
                      ...
                      <div class="icheck-primary">
                        ...
                        <a class="btn btn-sm btn-outline-warning" href="{{ route('admin.home_page_banner.edit', $page->id) }}"> <i class="fas fa-edit"></i> Edit</a>
                        <a class="btn btn-sm btn-outline-danger" onclick="return confirm('Are you sure want to delete?');" href="{{ route('admin.home_page_banner.delete', $page->id) }}"> <i class="fas fa-trash-alt"></i> Delete</a>
