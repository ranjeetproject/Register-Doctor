...
@section('body')
          @section('header', 'FAQ')
          @section('badge')
           <li class="breadcrumb-item"><a href="{{ route('admin.faq') }}">FAQ Lists</a></li>
          @endsection
            ...
            <div class="card-body p-0">
              ...
              <div class="mailbox-controls">
               ...
               {{--    <a href="" class="btn btn-default btn-sm"><i class="fas fa-eye"></i></a>
                  ...
                  <a href="{{ route('admin.faq.create') }}" data-toggle="tooltip" title="Add new FAQ" class="btn btn-primary btn-sm"><i class="fas fa-plus-square"></i> New</a>
                <!-- /.btn-group -->
                  ...
                  <tbody id="search_result">
                    @forelse ($faqs as $faq)
                      ...
                      <div class="icheck-primary">
                        <input type="checkbox" name="news_id[]" value="{{ $faq->id }}" id="check{{ $loop->iteration }}">
                        ...
                        <td>{{ $faq->answer  }}</td>
                        <td>
                        {{-- <a class="btn btn-sm btn-outline-primary" href="{{ route('admin.faq', $faq->id) }}"> <i class="fas fa-eye"></i> View</a> --}}
                        <a class="btn btn-sm btn-outline-warning" href="{{ route('admin.faq.edit', $faq->id) }}"> <i class="fas fa-edit"></i> Edit</a>
                        <a class="btn btn-sm btn-outline-danger" onclick="return confirm('Are you sure want to delete?');" href="{{ route('admin.faq.delete', $faq->id) }}"> <i class="fas fa-trash-alt"></i> Delete</a>
