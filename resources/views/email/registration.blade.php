            ...
            <tbody>
                ...
                <tr>
                    <td style="font-size:14px;padding-left:12px">
                        <center>
                            <h1>Welcome to Registered-Doctor.com</h1>
                        </center>
                        <br>
                        ...
                        @if ($user->role == 1)
                            ...
                            <center>
                                <a class="btn btn-primary"
                                    href="{{ route('email-verification', Crypt::encrypt($user->id)) }}">Click to
                                    verify</a>
                            </center>
                            <br>
                        ...
                        @if ($user->role == 2)
                            ...
                            <p>On clicking the activation link below you will be asked to upload a copy of your GMC
                                licence to practice medicine (or equivalent for non-UK doctors).
                            <p>

                            <p>You can download a copy from your GMC online account. Attach a screenshot (e.g. JPEG) or
                                the PDF. We will then check your details. Please watch your email and junk mail -
                                whitelist Registered-Doctor.com.</p>

                            <p>We usually verify details within 2 working days. Contact admin@registered-doctor.com if
                        ...
                        @if ($user->role == 3)
                            ...
                            <p>Please send us your pharmacy address and a contact phone number to
                                Admin@Registered-Doctor.com.</p>

                            <p>We are mainly interested in pharmacies with locations covering areas we have not yet
                                covered or those with extended opening hours and online pharmacists</p>

                            <p>We will be in touch shortly if you meet one of our current criteria so please watch your
                                email - also watch your junk mail and whitelist Registered-Doctor.com</p>
