            ...
            <tbody>
                ...
                <tr>
                    <td style="font-size:14px;padding-left:12px">
                        ...
                        <p>Your child {{ $child->name }} near to reach 18 years. please complete the following process. Convert your child
                            acoount to normal patient by clicking the below button</p>
...
<p>Click here to accept the above</p> --}}
                        ...
                        <br>
                        <center>
                            <a class="btn btn-primary" href="{{ route('child-to-adult', Crypt::encrypt($child->id)) }}">Convert child to normal patient on Your childs 18</a>
                        </center>
                    </td>
                </tr>
                <tr>
